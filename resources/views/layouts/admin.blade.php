...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
            <a href="{{ url('/') }}">
                <img alt="Logo" src="{{ asset('assets/images/logos/boiferry-main-white.svg') }}" class="h-30px" />
            </a>
                ...
                <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                    <div class="brand flex-column-auto" id="kt_brand">
                        <a href="{{ url('/') }}" class="brand-logo">
                            {{-- <h1>Management</h1> --}}
                            <img alt="Logo" src="{{ asset('assets/images/logos/boiferry-text-white.svg') }}" class="h-30px" />
                        </a>
                            ...
                            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                                <form action="{{ url('search') }}" method="GET">
                                    <div class="input-group input-group-sm bg-gray border-0 rounded pt-6" style="min-width: 300px;">
                                        <input type="text" class="form-control form-control-solid" name="q" placeholder="Search..." value="{{ request()->get('q') }}">
                                    </div>
                                </form>
                            </div>
                            <div class="topbar">
                                ...
                                {{-- <div class="dropdown mr-1">
                                    <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                        <div class="btn btn-icon btn-clean btn-dropdown btn-lg">
                                            <img class="h-20px w-20px rounded-sm" src="{{ asset('assets/images/flags/us.svg') }}" alt="" />
                                        </div>
                                    </div>
                                    <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                                        <ul class="navi navi-hover py-4">
                                            ...
                                            <li class="navi-item active">
                                                <a href="#" class="navi-link">
                                                    <span class="symbol symbol-20 mr-3">
                                                        <img src="{{ asset('assets/images/flags/bd.svg') }}" alt="" />
                                                    </span>
                    ...
                    <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                        <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                            ...
                            <div class="nav nav-dark">
                                <a href="{{ url('admin/help') }}" target="_blank" class="nav-link pl-0 pr-2">Help</a>
        ...
        <script src="{{ mix('assets/admin/js/plugins.js') }}"></script>
                    ...
                    buttons: ['copy', 'csv', 'excel',
                        {
                            ...
                            action: function (e, dt, button, config){
                                ...
                                dt.one('preXhr', function (e, s, data){
                                    ...
                                    $.fn.dataTable.ext.buttons.excelHtml5.action.call(dtThis, e, dt, button, config);
                                }).draw();
                            }
                        }
                    ]
                });
                table.buttons().container().prependTo( $('.card-toolbar'));
            }
            @stack('_scripts')
        </script>
    </body>
