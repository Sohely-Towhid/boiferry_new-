        ...
        <div class="card card-custom gutter-b">
            <div class="card-header border-0 pt-6">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder font-size-h4 text-dark-75">New Payout</span>
            ...
            <div class="card-body pt-6">
                <form action="{{ url('admin/payout') }}" method="POST" enctype="multipart/form-data">
                    @include('payout.form',['button'=>'Save Payout'])
                </form>
            </div>
        </div>
    </div>
