        ...
        <div class="card card-custom gutter-b">
            <div class="card-header border-1 pt-6 pb-2">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder font-size-h4 text-dark-75">New Coupon</span>
                    <span class="text-muted mt-3 font-weight-bold font-size-lg">Create New Coupon</span>
                </h3>
            ...
            <div class="card-body pt-6">
                <form action="{{ url('coupon') }}" method="POST" enctype="multipart/form-data">
                    @include('coupon.form',['button'=>'Save Coupon'])
                </form>
            </div>
        </div>
    </div>
