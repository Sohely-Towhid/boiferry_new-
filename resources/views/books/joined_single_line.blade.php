...
<div class="container ribbon">
    <div class="js-slick-carousel products no-gutters border-bottom t7" data-pagi-classes="d-xl-none text-center position-absolute right-0 left-0 u-slick__pagination mt-4 mb-0" data-arrows-classes="d-xl-block u-slick__arrow u-slick__arrow-centered--y" data-arrow-left-classes="fas fa-chevron-left u-slick__arrow-inner u-slick__arrow-inner--left ml-lg-n10" data-arrow-right-classes="fas fa-chevron-right u-slick__arrow-inner u-slick__arrow-inner--right mr-lg-n10" data-slides-show="{{ $_show }}" data-rows="{{ (@$_rows) ? $_rows : 0 }}" data-responsive='[{"breakpoint": 1500,"settings": {"slidesToShow": 4}},{"breakpoint": 1199,"settings": {"slidesToShow": 3}},{"breakpoint": 992,"settings": {"slidesToShow": 3, "arrows": true, "dots": false}}, {"breakpoint": 768,"settings": {"slidesToShow": 3, "arrows": true, "dots": false}}, {"breakpoint": 554,"settings": {"slidesToShow": 3, "arrows": true, "dots": false}}]'>
        @if($_loop)
                    ...
                    <div class="product__inner overflow-hidden p-3 p-md-4d875">
                        ...
                        <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
                            <div class="woocommerce-loop-product__thumbnail">
                                <a href="{{ url('/book/'.$_item->slug) }}" class="d-block">
                                    <img data-src="{{ showImage(@$_item->images[0], 'sm') }}" class="cover img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid" alt="{{ $_item->title }}">
                                </a>
                            </div>
                            <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                                <div class="text-uppercase font-size-1 mb-1 text-truncate"><a href="#">{{ __('web.'.$_item->type) }}</a></div>
                                <div class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark"><a href="{{ url('/book/'.$_item->slug) }}">{{ $_item->{'title'.$locale} }}</a></div>
