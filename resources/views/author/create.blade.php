        ...
        <div class="card card-custom gutter-b">
            <div class="card-header border-0 pt-6">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder font-size-h4 text-dark-75">New Author</span>
                    <span class="text-muted mt-3 font-weight-bold font-size-lg">Add New Author</span>
                </h3>
            ...
            <div class="card-body pt-6">
                <form action="{{ url('author') }}" method="POST" enctype="multipart/form-data">
                    @include('author.form',['button'=>'Save Author'])
                </form>
            </div>
        </div>
    </div>
